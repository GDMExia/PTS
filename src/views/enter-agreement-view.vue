<template>
    <div style="background-color:#F5F5F7">
        ...
        <div style="background-color:#fff;height:50px;width:83%;margin-left:8.5%;border-radius:50px;margin-top:-16px">
            ...
            <input type="text" v-model="phone" placeholder="请输入店主或联系人手机号码" style="width:24px;height:24px;background-color:#fff;height:50px;width:83%;display:inline-block;margin-top:-13px"/>
        </div>
        <div style="background-color:#fff;height:50px;width:83%;margin-left:8.5%;border-radius:50px;margin-top:10px">
            <div style="width:24px;height:50px;display:inline-block;margin-left:4%" >
