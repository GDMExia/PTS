...
<!--            </div>-->
        ...
        <div>
          <div
            ...
            ref="scrollBox"
            @scroll="menuScroll"
            v-if="activityList.length&&type==0"
          >
            <div
            ...
            >
              <div
                class="container"
                @click="handleClick(item.tourism_id)"
...
<!--                    </div>-->
<!--                </div>-->
<!--                &lt;!&ndash; <load-more v-show="pageNum > totalPage" :show-loading="false" :tip="'暂无更多'" background-color="#fbf9fe"></load-more> &ndash;&gt;-->
<!--            </scroller>-->
          <div
            class="menu"
            :style="scrollBoxStyle"
            ref="scrollBox"
            @scroll="menuScroll"
            v-if="articleList.length&&type==1"
          >
            <div
              class="scrollBoxMain"
              ref="scrollBoxMain"
...
export default {
    ...
    methods: {
        ...
        getotherArticleList() {
            this.$http
                .get(
                    `${this.rootPath}/Index/getArticle?page=${this.page}&pageSize=${this.pageSize}&keywords=${this.search}`
                )
                .then(res => {
        ...
        getSchoolArticleList(){
            this.$http.get(`${this.rootPath}/Index/getArticle?page=${this.page}&pageSize=${this.pageSize}&keywords=${this.search}`).then(res=>{
                console.log(res)
                if(res.data.StatusInfo.success){
                // Object.assign(this.articleList,res.data.articleList)
