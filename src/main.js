...
router.beforeEach((to, from, next) => {
  ...
  if(to.fullPath.indexOf('merchantLogin')>=0||to.fullPath.indexOf('merchantHome')>=0||to.fullPath.indexOf('merchantCheck')>=0){
    ...
    if(search){
      ...
      // location.href = `http://pts.suoqoo.com/home.php/WechatLogin/accountLogin?callback_url=http://192.168.9.103:8080/#${to.fullPath}`
...
// });
>>>>>>> 0aff20dd6f3c0162bef0923015e86c2615b62eb1
